...
public class OrderTest {
    ...
    void weightedFactorTest() {
        ...
        assertEquals(order2.getWeightedFactor(), new BigDecimal("1.25"));
        assertEquals(order3.getWeightedFactor(), new BigDecimal("-8.75"));
        assertEquals(order1.getWeightedFactor(), new BigDecimal("85.00"));
    }
    ...
    void sortingTest() {
        ...
        assertEquals(orders.get(0).getWeightedFactor(), new BigDecimal("85.00"));
        assertEquals(orders.get(2).getWeightedFactor(), new BigDecimal("-8.75"));
    }
}
